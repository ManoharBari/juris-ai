    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="mb-6">
            <h1 className="text-2xl font-semibold text-gray-900">Welcome back to Juris AI</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs text-[#3B9EF5] hover:underline">Forgot password?</Link>
              </div>
              <Input
                id="password"
                type="password"
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/signup" className="text-[#3B9EF5] font-medium hover:underline">
            Sign up free
          </Link>
        </p>
      </div>
