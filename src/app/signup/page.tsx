  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="flex items-center justify-center gap-2.5 mb-8"></div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Start reviewing contracts with AI — free forever
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-gray-400 text-center">
              ...
              <Link href="#" className="text-[#3B9EF5] hover:underline">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="#" className="text-[#3B9EF5] hover:underline">
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link
            href="/signin"
            className="text-[#3B9EF5] font-medium hover:underline"
          >
            Sign in
          </Link>
        </p>
