        ...
        <div id="print-report" className="print-only">
            ...
            <div className="report-stats">
                {[
                    ...
                    { label: "Law Violations", value: analysis.keyStats.lawViolationCount },
                ].map((s) => (
                ...
                {analysis.clauses.map((clause, i) => (
                    <div className="report-clause" key={clause.id}>
                        ...
                        {clause.isUnfair && clause.unfairReason && (
                            ...
                            >
                                <p className="report-callout-label" style={{ color: "#dc2626" }}>
                        ...
                        {clause.indianLawReference.act && (
                            ...
                            >
                                ...
                                {clause.indianLawReference.section && (
                                    <p className="report-callout-body" style={{ color: "#374151" }}>
                                        {clause.indianLawReference.section}
                                    </p>
                                )}
                                {clause.indianLawReference.note && (
                                    <p className="report-callout-body" style={{ color: "#6b7280", marginTop: 4 }}>
                                        {clause.indianLawReference.note}
                                    </p>
                                )}
                            </div>
                        ...
                        {clause.redlineSuggestion && (
                            ...
                            >
                                <p className="report-callout-label" style={{ color: "#1d4ed8" }}>
                                    ✎ Suggested Redline
                                </p>
                                ...
                                {clause.legalCitation && (
                                    <p
                                        ...
                                        style={{ color: "#3b82f6", fontStyle: "italic", marginTop: 4 }}
                                    >
            ...
            <div className="report-footer">
                ...
                <span>This report is for informational purposes only and does not constitute legal advice.</span>
            </div>
        </div>
    );
}
